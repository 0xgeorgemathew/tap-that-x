...
contract USDCTapPayment is ReentrancyGuard {
    ...
    event TapPaymentExecuted(address indexed owner, bytes32 indexed nonce);
    ...
    /// @dev Full payment details are emitted by TapThatXProtocol.AuthorizedCallExecuted event
